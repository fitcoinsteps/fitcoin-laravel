...
<body class="bg-black text-white min-h-screen overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center gap-7">
                    <a href="/admin/dashboard" class="text-sm font-medium text-gray-300 hover:text-white transition">Dashboard</a>
                    <a href="#" class="text-sm font-medium text-gray-300 hover:text-white transition">Users</a>
                    <a href="#" class="text-sm font-medium text-gray-300 hover:text-white transition">Reports</a>
                    <a href="#" class="text-sm font-medium text-gray-300 hover:text-white transition">Settings</a>
                </nav>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 bg-indigo-600 rounded-full flex items-center justify-center text-white text-sm font-bold">A</div>
    ...
    <script>
        ...
        .then(user => {
            ...
            document.getElementById('user-name').textContent = `${user.first_name} ${user.last_name} (super-admin)`;
        })
        .catch(() => {
            window.location.href = '/login';
        });
